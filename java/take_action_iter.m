function [ psprime ] = take_action_iter( ps, opt, t, a, delta_t )
...
%         t_next = min( t_end, event(event_no,1) );
        ...
        % [hostetje] This take_action calls 'simgrid_split()', which is an
        % iterative re-implementation of 'simgrid_interval()' that tries to
        % preserve the original behavior.
        psprime = simgrid_split( psprime, t, t_next, opt );
